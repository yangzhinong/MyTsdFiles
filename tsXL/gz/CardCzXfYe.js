$(document).ready(function () {
    $('a.a-cz-lnk').click(function () {
        ...
        layer.load("正在加载...");
        $.post("/Report/CardCzXfYeCZDetail", sParam, function (data) {
            layer.closeAll();
            if (data.code) {
    ...
    $('a.a-xf-lnk').click(function () {
        ...
        sParam = "moneyType=" + moneyType + '&' + sParam;
        layer.load("正在加载...");
        $.post("/Report/CardCzXfYeXfDetail", sParam, function (data) {
            layer.closeAll();
            if (data.code) {
                BootstrapDialog.alert({
                    title: '消费详情',
    ...
    $('td.cardno').live('click', function () {
        ...
        if (cardno.length > 0) {
            ...
            $.post('/Report/CardJournalAccount', sParam, function (data) {
                if (data.code) {
                    BootstrapDialog.alert({
