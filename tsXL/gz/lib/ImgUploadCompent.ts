...
二, 初始化上传多图按钮. 
    (function(){
        ...
        var typeId=69;
        InitMutiImgUpLoadButton($btn,typeId);
...
function ImgUploadCompent($txts:JQuery, paths: string, fcbReponse:()=>void) {
...
function InitMutiImgUpLoadButton($btns: JQuery, typeId: number, opt?: { Id?: number, paths?: string }) {
